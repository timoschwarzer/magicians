...
Companion app for the card game Wizard.

https://magicians.timo.page

> [!NOTE]  
> This is a companion app that helps keeping track of everything in the game, especially for the more complex variants. It is not an implementation of the game itself, you still need a physical copy of any variant of the card game Wizard.


## Features

- No installation necessary, works in any major browser
- Unlimited player count
- Unlimited rounds
- Keep track of points, trump color, predictions etc.
- Automatic points distribution
- Large, upside-down view of predictions for other players to read


## How to use

All players need a mobile device with internet access. While tablet devices work, I found them using too much space on the table, so I recommend using smaller devices.
...
Copyright (c) 2026 - Timo Schwarzer
...
No AI was used to create and develop this project.